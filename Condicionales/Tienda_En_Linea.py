# Sistema de una tienda en linea que aplica un descuento dependiento del monto de la compra y si somos miembros.
...
# Hacemos los respectivos calculos para obtener el monto final.
if descuento != 0:
